...
Plugin is easy to use: just install it, use short code [email] and it just works.
...
2. use short code [email] in your pages, posts, or widgets where you want to display your mailto email address.